...
__all__ = ['import_from_files', 'import_from_csv', 'create_tfidf', 'get_phrases', 'get_vectors', 'assign_clusters',
           'visualize_clustering', 'get_cluster_topics', 'get_doc_topics', 'evaluate']
...
def import_from_files(path_to_file_list:str, save_results:bool = False, file_name:str = 'output/DocumentSentenceList.txt',
    ...
    data, doc_df = internal.import_data(raw_docs, save_results, file_name, stop_words_file)
    return data, doc_df
