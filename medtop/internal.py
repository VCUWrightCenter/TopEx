...
__all__ = ['set_phrase_column', 'set_vec_column_tfidf', 'set_vec_column_w2v', 'get_silhouette_score_hac',
           'get_tree_height', 'get_linkage_matrix', 'get_optimal_height', 'get_cluster_assignments_hac',
           'get_silhouette_score_kmeans', 'get_optimal_k', 'get_cluster_assignments_kmeans']
